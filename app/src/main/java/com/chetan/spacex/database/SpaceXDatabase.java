...
public abstract class SpaceXDatabase extends RoomDatabase {
    ...
    public static synchronized SpaceXDatabase getInstance(Context context) {
        ...
        if (instance == null) {
            ...
            instance =
                    ...
                    Room.databaseBuilder(context.getApplicationContext(),
                                    SpaceXDatabase.class, "spacex_database")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        PopulateDbAsyncTask(SpaceXDatabase instance) {
            SpaceXDao spaceXDao = instance.spaceXDao();
        }
